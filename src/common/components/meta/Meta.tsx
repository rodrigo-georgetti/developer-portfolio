const Meta = () => {
  return (
    <>
      ...
      <title> Rodrigo Georgetti : Portfolio </title>

      <meta name="description" content='Curioso y analítico frente a los desafios, con inicitiva y compromiso para colaborar en equipo' />
      <meta
        name="keywords"
      ...
      <meta property="og:site_name" content="Rodrigo Georgetti" />
      <meta property="og:title" content='Rodrigo Georgetti | Portfolio' />
